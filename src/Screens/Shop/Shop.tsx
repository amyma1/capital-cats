...
export const Shop = ({showShop, handleShowShop, acc, handleSetAcc} : shopProps) => {
  ...
  return (
        ...
        <label htmlFor="modal-btn text-center" style={{marginBottom:"200px", marginLeft:"300px", width:"80px"}}>
            Shop
        ...
        <div className="row">
          ...
          <img src={hat} onClick={() => handleSetAcc(1)}  style={{width:"100%"}} alt=""/>
          </div>
          <div className="column">
            <img src={boot} onClick={() => handleSetAcc(2)} style={{width:"100%"}} alt=""/>
          </div>
          <div className="column">
            <img src={food} onClick={() => handleSetAcc(4)} style={{width:"100%"}} alt=""/>
          </div>
        </div>
